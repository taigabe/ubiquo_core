module Ubiquo::Concerns::Settings
  ...
  module ClassMethods
    ...
    def sort_settings(setting_keys)
    ...
    def sort_contexts(context_keys)
      prioritary_sorting(context_keys, :prioritary_contexts)
    end

    def prioritary_sorting(input, key)
      output = []
    ...
    def boolean(name = nil, default_value = nil, options = {}, &block)
      options.merge!(:value_type => UbiquoBooleanSetting)
      uhook_add(name, default_value, options, &block)
    end

    def integer(name = nil, default_value = nil, options = {}, &block)
      options.merge!(:value_type => UbiquoIntegerSetting)
      uhook_add(name, default_value, options, &block)
    end

    def string(name = nil, default_value = nil, options = {}, &block)
      options.merge!(:value_type => UbiquoStringSetting)
      uhook_add(name, default_value, options, &block)
    end

    def symbol(name = nil, default_value = nil, options = {}, &block)
      options.merge!(:value_type => UbiquoSymbolSetting)
      uhook_add(name, default_value, options, &block)
    end

    def email(name = nil, default_value = nil, options = {}, &block)
      options.merge!(:value_type => UbiquoEmailSetting)
      uhook_add(name, default_value, options, &block)
    end

    def password(name = nil, default_value = nil, options = {}, &block)
      options.merge!(:value_type => UbiquoPasswordSetting)
      uhook_add(name, default_value, options, &block)
    end

    def list(name = nil, default_value = nil, options = {}, &block)
      options.merge!(:value_type => UbiquoListSetting)
      uhook_add(name, default_value, options, &block)
    end

    def check_type(klass, values)
    ...
    def add(name = nil, default_value = nil, options = {}, &block)
      uhook_add(name, default_value, options, &block)
    end

    # example inherited_value format = 'ubiquo.elements_per_page'
    def add_inheritance(name, inherited_value)
    ...
    #  => 3
    def set_default(name = nil, default_value = nil, &block)
    ...
    #  >> Ubiquo::Settings.get(:c)
    #  => 3
    def set(name = nil, value = nil, options = {}, &block)
    ...
    def option_exists?(name, options = {})
    ...
    def check_valid_context_name(name)
      self.check_valid_name(name) || !@loaded
    end

    def block_assignment(&block)
    ...
    # the 'add' method
    #
    def new_context_options(name = self.current_context)
    ...
    def initialize_settings options = {}
