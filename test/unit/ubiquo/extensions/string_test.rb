...
class Ubiquo::Extensions::StringTest < ActiveSupport::TestCase
  ...
  test "should truncate by word" do
    ...
    assert_equal "hello...",       "hello world too long".truncate_words(:length => 8)
    assert_equal "hello...",       "hello world too long".truncate_words(:length => 13)
    assert_equal "hello world...", "hello world too long".truncate_words(:length => 14)
    assert_equal "hello world...", "<p>hello world too long</p>".truncate_words(:length => 14)
    
  end
  
  test "should center truncation on word" do 
    
    assert_equal "...b c d...", "a b c d e f g h".truncate_words(:length => 12, :center => "c")
    assert_equal "...b c d...", "a b c d e f g h".truncate_words(:length => 13, :center => "c")
    assert_equal "...b c d...", "a b c d e f g h".truncate_words(:length => 14, :center => "c")
    assert_equal "...a b c d e...", "a b c d e f g h i j k".truncate_words(:length => 15, :center => "c")
    assert_equal "...b c d...", "a <p>b</p> <div>c</div> <div>d</div> e f g h".truncate_words(:length => 14, :center => "c")
    
    assert_equal "...b HOLA d...", "a b HOLA d e f g h i j k".truncate_words(:length => 14, :center => "HOLA")
  end
  ...
  test "some real example" do 
    assert_equal "...de dos partes: la primera, El ingenioso hidalgo don <span class=\"quijote\">Quijote</span> de la <span class=\"quijote\">Mancha</span>, fue publicada en...", <<QUIJOTE.truncate_words(:length => 100, :center => "hidalgo", :highlight => ["Quijote", "Mancha"], :highlight_class => "quijote")
